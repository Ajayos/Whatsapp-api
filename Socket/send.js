...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata }) => {
        ...
        const destinationJid = (0, Binary_1.jidEncode)(user, destinationServer);
        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroup) {
                ...
                const patched = await patchMessageBeforeSending(message, devices.map(d => (0, Binary_1.jidEncode)(d.user, 's.whatsapp.net', d.device)));
                const bytes = (0, Utils_1.encodeWAMessage)(patched);
                ...
                for (const { user, device } of devices) {
                    const jid = (0, Binary_1.jidEncode)(user, 's.whatsapp.net', device);
                ...
                const { user: meUser } = (0, Binary_1.jidDecode)(meId);
                if (!participant) {
                    devices.push({ user });
                    ...
                    if (result) {
                        if (result.error) {
                            ...
                            try {
                                ...
                                if (media.result !== Proto_1.proto.MediaRetryNotification.ResultType.SUCCESS) {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                const value = typeof disappearingMessagesInChat === 'boolean' ?
                    (disappearingMessagesInChat ? Base_1.WA_DEFAULT_EPHEMERAL : 0) :
                ...
                if (isDeleteMsg) {
                    ...
                    if ((0, Binary_1.isJidGroup)((_a = content.delete) === null || _a === void 0 ? void 0 : _a.remoteJid) && !((_b = content.delete) === null || _b === void 0 ? void 0 : _b.fromMe)) {
