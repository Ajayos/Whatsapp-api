...
const makeGroupsSocket = (config) => {
    ...
    return {
        ...
        groupRequestParticipantsList: async (jid) => {
            ...
            const node = (0, Binary_1.getBinaryNodeChild)(result, 'membership_approval_requests');
            const participants = (0, Binary_1.getBinaryNodeChildren)(node, 'membership_approval_request');
        ...
        groupRequestParticipantsUpdate: async (jid, participants, action) => {
            ...
            const node = (0, Binary_1.getBinaryNodeChild)(result, 'membership_requests_action');
            const nodeAction = (0, Binary_1.getBinaryNodeChild)(node, action);
            const participantsAffected = (0, Binary_1.getBinaryNodeChildren)(nodeAction, 'participant');
        ...
        groupParticipantsUpdate: async (jid, participants, action) => {
            ...
            const participantsAffected = (0, Binary_1.getBinaryNodeChildren)(node, 'participant');
            return participantsAffected.map(p => {
                return { status: p.attrs.error || '200', jid: p.attrs.jid };
            });
        },
        ...
        groupAcceptInviteV4: ev.createBufferedFunction(async (key, inviteMessage) => {
            ...
            if (key.id) {
                ...
                inviteMessage = Proto_1.proto.Message.GroupInviteMessage.fromObject(inviteMessage);
...
const extractGroupMetadata = (result) => {
    ...
    const approvalMode = (_b = (_a = (0, Binary_1.getBinaryNodeChild)((0, Binary_1.getBinaryNodeChild)(group, 'membership_approval_mode'), 'group_join')) === null || _a === void 0 ? void 0 : _a.attrs) === null || _b === void 0 ? void 0 : _b.state;
    const groupId = group.attrs.id.includes('@') ? group.attrs.id : (0, Binary_1.jidEncode)(group.attrs.id, 'g.us');
    const eph = (_c = (0, Binary_1.getBinaryNodeChild)(group, 'ephemeral')) === null || _c === void 0 ? void 0 : _c.attrs.expiration;
    const metadata = {
        id: groupId,
        ...
        owner: group.attrs.creator ? (0, Binary_1.jidNormalizedUser)(group.attrs.creator) : undefined,
        desc,
        descId,
        ...
        participants: (0, Binary_1.getBinaryNodeChildren)(group, 'participant').map(({ attrs }) => {
            return {
                id: attrs.jid,
