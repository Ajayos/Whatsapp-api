...
export declare const jidDecode: (
...
/** is the jid a user */
export declare const isJidUser: (
  jid: string | undefined,
) => boolean | undefined;
/** is the jid a group */
export declare const isLidUser: (
  jid: string | undefined,
) => boolean | undefined;
/** is the jid a broadcast */
export declare const isJidBroadcast: (
  jid: string | undefined,
) => boolean | undefined;
/** is the jid a group */
export declare const isJidGroup: (
  jid: string | undefined,
) => boolean | undefined;
