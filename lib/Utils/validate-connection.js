...
const getUserAgent = ({ version }) => {
    ...
    return {
        ...
        platform: Proto_1.proto.ClientPayload.UserAgent.Platform.WEB,
        releaseChannel: Proto_1.proto.ClientPayload.UserAgent.ReleaseChannel.RELEASE,
        mcc: '000',
        mnc: '000',
        osVersion: osVersion,
        manufacturer: '',
...
const getWebInfo = (config) => {
    let webSubPlatform = Proto_1.proto.ClientPayload.WebInfo.WebSubPlatform.WEB_BROWSER;
...
const generateRegistrationNode = ({ registrationId, signedPreKey, signedIdentityKey }, config) => {
    ...
    const companion = {
        ...
        platformType: Proto_1.proto.DeviceProps.PlatformType[config.browser[1].toUpperCase()]
            || Proto_1.proto.DeviceProps.PlatformType.UNKNOWN,
    ...
    const registerPayload = {
        ...
        devicePairingData: {
            ...
            eKeytype: Base_1.KEY_BUNDLE_TYPE,
...
const configureSuccessfulPairing = (stanza, { advSecretKey, signedIdentityKey, signalIdentities }) => {
    ...
    const pairSuccessNode = (0, Binary_1.getBinaryNodeChild)(stanza, 'pair-success');
    const deviceIdentityNode = (0, Binary_1.getBinaryNodeChild)(pairSuccessNode, 'device-identity');
    const platformNode = (0, Binary_1.getBinaryNodeChild)(pairSuccessNode, 'platform');
    const deviceNode = (0, Binary_1.getBinaryNodeChild)(pairSuccessNode, 'device');
    ...
    const { details, hmac } = Proto_1.proto.ADVSignedDeviceIdentityHMAC.decode(deviceIdentityNode.content);
    // check HMAC matches
    ...
    const deviceIdentity = Proto_1.proto.ADVDeviceIdentity.decode(account.details);
    const reply = {
        tag: 'iq',
        attrs: {
...
const encodeSignedDeviceIdentity = (account, includeSignatureKey) => {
    ...
    const accountEnc = Proto_1.proto.ADVSignedDeviceIdentity
        .encode(account)
        .finish();
    return accountEnc;
};
