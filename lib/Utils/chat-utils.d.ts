...
export declare const processSyncAction: (syncAction: ChatMutation, ev: KeerthanaEventEmitter, me: Contact, initialSyncOpts?: InitialAppStateSyncOptions, logger?: Logger) => void;
export {};
