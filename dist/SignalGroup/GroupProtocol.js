...
$root.groupproto = (function () {
  ...
  groupproto.SenderKeyDistributionMessage = (function () {
    ...
    SenderKeyDistributionMessage.fromObject = function fromObject(object) {
      ...
      if (object.chainKey != null)
        ...
        else if (object.chainKey.length) message.chainKey = object.chainKey;
    ...
    SenderKeyDistributionMessage.toObject = function toObject(
      ...
      if (options.defaults) {
        object.id = 0;
        object.iteration = 0;
        if (options.bytes === String) object.chainKey = "";
        else {
          object.chainKey = [];
          if (options.bytes !== Array)
            object.chainKey = $util.newBuffer(object.chainKey);
        }
        if (options.bytes === String) object.signingKey = "";
        else {
          object.signingKey = [];
          if (options.bytes !== Array)
  ...
  groupproto.SenderChainKey = (function () {
    ...
    SenderChainKey.fromObject = function fromObject(object) {
      ...
      if (object.seed != null)
        ...
        else if (object.seed.length) message.seed = object.seed;
      return message;
    };
    ...
    SenderChainKey.toObject = function toObject(message, options) {
      ...
      if (options.defaults) {
        object.iteration = 0;
        if (options.bytes === String) object.seed = "";
        else {
          object.seed = [];
          if (options.bytes !== Array)
  ...
  groupproto.SenderMessageKey = (function () {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SenderMessageKey.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
  ...
  groupproto.SenderSigningKey = (function () {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SenderSigningKey.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    SenderSigningKey.fromObject = function fromObject(object) {
      ...
      if (object["public"] != null)
        ...
        else if (object["public"].length) message["public"] = object["public"];
    ...
    SenderSigningKey.toObject = function toObject(message, options) {
      ...
      var object = {};
      if (options.defaults) {
        if (options.bytes === String) object["public"] = "";
        else {
          object["public"] = [];
          if (options.bytes !== Array)
  ...
  groupproto.SenderKeyStateStructure = (function () {
    ...
    SenderKeyStateStructure.encode = function encode(message, writer) {
      ...
      if (
        ...
        $root.groupproto.SenderChainKey.encode(
      ...
      if (
        ...
        $root.groupproto.SenderSigningKey.encode(
      ...
      if (message.senderMessageKeys != null && message.senderMessageKeys.length)
        for (var i = 0; i < message.senderMessageKeys.length; ++i)
          $root.groupproto.SenderMessageKey.encode(
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SenderKeyStateStructure.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            break;
          case 2:
            message.senderChainKey = $root.groupproto.SenderChainKey.decode(
              reader,
              reader.uint32(),
            );
            break;
          case 3:
            message.senderSigningKey = $root.groupproto.SenderSigningKey.decode(
              reader,
              reader.uint32(),
            );
            break;
          case 4:
            ...
            message.senderMessageKeys.push(
              $root.groupproto.SenderMessageKey.decode(reader, reader.uint32()),
            );
            break;
          default:
            reader.skipType(tag & 7);
    ...
    SenderKeyStateStructure.verify = function verify(message) {
      ...
      if (
        ...
        var error = $root.groupproto.SenderChainKey.verify(
          message.senderChainKey,
        );
      ...
      if (
        ...
        var error = $root.groupproto.SenderSigningKey.verify(
          message.senderSigningKey,
        );
        if (error) return "senderSigningKey." + error;
      }
      if (
        message.senderMessageKeys != null &&
        ...
        for (var i = 0; i < message.senderMessageKeys.length; ++i) {
          var error = $root.groupproto.SenderMessageKey.verify(
            message.senderMessageKeys[i],
          );
    ...
    SenderKeyStateStructure.fromObject = function fromObject(object) {
      ...
      if (object.senderChainKey != null) {
        if (typeof object.senderChainKey !== "object")
          throw TypeError(
            ".groupproto.SenderKeyStateStructure.senderChainKey: object expected",
          );
        message.senderChainKey = $root.groupproto.SenderChainKey.fromObject(
      ...
      if (object.senderSigningKey != null) {
        if (typeof object.senderSigningKey !== "object")
          throw TypeError(
            ".groupproto.SenderKeyStateStructure.senderSigningKey: object expected",
          );
        message.senderSigningKey = $root.groupproto.SenderSigningKey.fromObject(
      ...
      if (object.senderMessageKeys) {
        if (!Array.isArray(object.senderMessageKeys))
          throw TypeError(
            ".groupproto.SenderKeyStateStructure.senderMessageKeys: array expected",
          );
        message.senderMessageKeys = [];
        for (var i = 0; i < object.senderMessageKeys.length; ++i) {
          if (typeof object.senderMessageKeys[i] !== "object")
            throw TypeError(
              ".groupproto.SenderKeyStateStructure.senderMessageKeys: object expected",
            );
          message.senderMessageKeys[i] =
            $root.groupproto.SenderMessageKey.fromObject(
    ...
    SenderKeyStateStructure.toObject = function toObject(message, options) {
      ...
      if (
        ...
        object.senderChainKey = $root.groupproto.SenderChainKey.toObject(
          message.senderChainKey,
          options,
        );
      if (
        ...
        object.senderSigningKey = $root.groupproto.SenderSigningKey.toObject(
          message.senderSigningKey,
          options,
        );
      if (message.senderMessageKeys && message.senderMessageKeys.length) {
        ...
        for (var j = 0; j < message.senderMessageKeys.length; ++j)
          object.senderMessageKeys[j] =
            $root.groupproto.SenderMessageKey.toObject(
  ...
  groupproto.SenderKeyRecordStructure = (function () {
    ...
    SenderKeyRecordStructure.encode = function encode(message, writer) {
      ...
      if (message.senderKeyStates != null && message.senderKeyStates.length)
        for (var i = 0; i < message.senderKeyStates.length; ++i)
          $root.groupproto.SenderKeyStateStructure.encode(
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SenderKeyRecordStructure.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            message.senderKeyStates.push(
              $root.groupproto.SenderKeyStateStructure.decode(
                reader,
                reader.uint32(),
              ),
            );
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SenderKeyRecordStructure.decodeDelimited = function decodeDelimited(
      reader,
    ) {
      if (!(reader instanceof $Reader)) reader = new $Reader(reader);
      return this.decode(reader, reader.uint32());
    ...
    SenderKeyRecordStructure.fromObject = function fromObject(object) {
      ...
      if (object.senderKeyStates) {
        if (!Array.isArray(object.senderKeyStates))
          throw TypeError(
            ".groupproto.SenderKeyRecordStructure.senderKeyStates: array expected",
          );
        message.senderKeyStates = [];
        for (var i = 0; i < object.senderKeyStates.length; ++i) {
          if (typeof object.senderKeyStates[i] !== "object")
            throw TypeError(
              ".groupproto.SenderKeyRecordStructure.senderKeyStates: object expected",
            );
          message.senderKeyStates[i] =
            $root.groupproto.SenderKeyStateStructure.fromObject(
      ...
      if (message.senderKeyStates && message.senderKeyStates.length) {
        ...
        for (var j = 0; j < message.senderKeyStates.length; ++j)
          object.senderKeyStates[j] =
            $root.groupproto.SenderKeyStateStructure.toObject(
