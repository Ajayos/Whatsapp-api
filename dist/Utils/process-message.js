...
const cleanMessage = (message, meId) => {
    ...
    message.key.remoteJid = (0, Binary_1.jidNormalizedUser)(message.key.remoteJid);
    ...
    function normaliseKey(msgKey) {
        ...
        if (!message.key.fromMe) {
            ...
            msgKey.fromMe = !msgKey.fromMe
                ? (0, Binary_1.areJidsSameUser)(msgKey.participant || msgKey.remoteJid, meId)
...
const isRealMessage = (message, meId) => {
    ...
    return ((!!normalizedContent ||
        ...
        (REAL_MSG_REQ_ME_STUB_TYPES.has(message.messageStubType) &&
            ((_a = message.messageStubParameters) === null || _a === void 0 ? void 0 : _a.some((p) => (0, Binary_1.areJidsSameUser)(meId, p))))) &&
        hasSomeContent &&
...
const getChatId = ({ remoteJid, participant, fromMe, }) => {
    if ((0, Binary_1.isJidBroadcast)(remoteJid) &&
...
const processMessage = async (message, { shouldProcessHistoryMsg, ev, creds, keyStore, logger, options, getMessage, }) => {
    ...
    if (protocolMsg) {
            ...
            case Proto_1.proto.Message.ProtocolMessage.Type
                ...
                if (response) {
                    ...
                    for (const result of peerDataOperationResult) {
                        ...
                        if (retryResponse) {
                            const webMessageInfo = Proto_1.proto.WebMessageInfo.decode(retryResponse.webMessageInfoBytes);
                            ev.emit("messages.update", [
                                {
        ...
        const participantsIncludesMe = () => participants.find((jid) => (0, Binary_1.areJidsSameUser)(meId, jid));
