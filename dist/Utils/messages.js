 ...
 */
const extractUrlFromText = (text) => { var _a; return !Base_1.URL_EXCLUDE_REGEX.test(text) ? (_a = text.match(Base_1.URL_REGEX)) === null || _a === void 0 ? void 0 : _a[0] : undefined; };
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    const messageJSON = {
        ...
        participant: (0, Binary_1.isJidGroup)(jid) || (0, Binary_1.isJidStatusBroadcast)(jid) ? userJid : undefined,
