...
const makeChatsSocket = (config) => {
    ...
    const fetchPrivacySettings = async (force = false) => {
        if (!privacySettings || force) {
            ...
            privacySettings = (0, Binary_1.reduceBinaryNodeToDictionary)(content === null || content === void 0 ? void 0 : content[0], 'category');
        }
    ...
    const fetchBlocklist = async () => {
        ...
        return (0, Binary_1.getBinaryNodeChildren)(listNode, 'item').map(n => n.attrs.jid);
    };
    ...
    const getBusinessProfile = async (jid) => {
        ...
        const profileNode = (0, Binary_1.getBinaryNodeChild)(results, 'business_profile');
        ...
        if (profiles) {
            ...
            const description = (0, Binary_1.getBinaryNodeChild)(profiles, 'description');
            const website = (0, Binary_1.getBinaryNodeChild)(profiles, 'website');
            const email = (0, Binary_1.getBinaryNodeChild)(profiles, 'email');
            const category = (0, Binary_1.getBinaryNodeChild)((0, Binary_1.getBinaryNodeChild)(profiles, 'categories'), 'category');
            const businessHours = (0, Binary_1.getBinaryNodeChild)(profiles, 'business_hours');
            const businessHoursConfig = businessHours
                ? (0, Binary_1.getBinaryNodeChildren)(businessHours, 'business_hours_config')
                : undefined;
    ...
    const fetchProps = async () => {
        ...
        if (propsNode) {
            // @ts-ignore
            (_b = authState === null || authState === void 0 ? void 0 : authState.creds) === null || _b === void 0 ? void 0 : _b.lastPropHash = (_c = propsNode === null || propsNode === void 0 ? void 0 : propsNode.attrs) === null || _c === void 0 ? void 0 : _c.hash;
    ...
    const upsertMessage = ev.createBufferedFunction(async (msg, type) => {
        ...
        const shouldProcessHistoryMsg = historyMsg
            ? shouldSyncHistoryMessage(historyMsg) &&
                Base_1.PROCESSABLE_HISTORY_TYPES.includes(historyMsg.syncType)
            : false;
