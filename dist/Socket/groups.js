...
const extractGroupMetadata = (result) => {
    ...
    const eph = (_a = (0, Binary_1.getBinaryNodeChild)(group, 'ephemeral')) === null || _a === void 0 ? void 0 : _a.attrs.expiration;
    const memberAddMode = (0, Binary_1.getBinaryNodeChildString)(group, 'member_add_mode') === 'all_member_add';
    const metadata = {
        id: groupId,
        ...
        desc,
        descId,
        linkedParent: ((_b = (0, Binary_1.getBinaryNodeChild)(group, 'linked_parent')) === null || _b === void 0 ? void 0 : _b.attrs.jid) || undefined,
        ...
        isCommunityAnnounce: !!(0, Binary_1.getBinaryNodeChild)(group, 'default_sub_group'),
        joinApprovalMode: !!(0, Binary_1.getBinaryNodeChild)(group, 'membership_approval_mode'),
        memberAddMode,
