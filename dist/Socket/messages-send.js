...
const makeMessagesSocket = (config) => {
    ...
    const refreshMediaConn = async (forceGet = false) => {
        ...
        if (!media ||
            ...
            mediaConn = (async () => {
                ...
                const mediaConnNode = (0, Binary_1.getBinaryNodeChild)(result, 'media_conn');
                const node = {
                    hosts: (0, Binary_1.getBinaryNodeChildren)(mediaConnNode, 'host').map(({ attrs }) => ({
    ...
    const getUSyncDevices = async (jids, useCache, ignoreZeroDevices) => {
        ...
        for (let jid of jids) {
            const user = (_a = (0, Binary_1.jidDecode)(jid)) === null || _a === void 0 ? void 0 : _a.user;
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList, }) => {
        ...
        const destinationJid = !isStatus
            ? (0, Binary_1.jidEncode)(user, isLid ? 'lid' : isGroup ? 'g.us' : 's.whatsapp.net')
            : statusJid;
        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroup || isStatus) {
                ...
                const patched = await patchMessageBeforeSending(message, devices.map(d => (0, Binary_1.jidEncode)(d.user, isLid ? 'lid' : 's.whatsapp.net', d.device)));
                const bytes = (0, Utils_1.encodeWAMessage)(patched);
                ...
                for (const { user, device } of devices) {
                    const jid = (0, Binary_1.jidEncode)(user, isLid ? 'lid' : 's.whatsapp.net', device);
                ...
                const { user: meUser, device: meDevice } = (0, Binary_1.jidDecode)(meId);
                if (!participant) {
                    devices.push({ user });
                ...
                for (const { user, device } of devices) {
                    ...
                    const jid = (0, Binary_1.jidEncode)(isMe && isLid
                        ? ((_b = (_a = authState.creds) === null || _a === void 0 ? void 0 : _a.me) === null || _b === void 0 ? void 0 : _b.lid.split(':')[0]) || user
                        ...
                        if (result.error) {
                            ...
                            try {
                                ...
                                if (media.result !==
                                    ...
                                    const resultStr = Proto_1.proto.MediaRetryNotification.ResultType[media.result];
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                if (isDeleteMsg) {
                    ...
                    if ((0, Binary_1.isJidGroup)((_a = content.delete) === null || _a === void 0 ? void 0 : _a.remoteJid) &&
