...
const extractUrlFromText = (text) => {
  var _a;
  return !Base_1.URL_EXCLUDE_REGEX.test(text)
    ? (_a = text.match(Base_1.URL_REGEX)) === null || _a === void 0
      ? void 0
      : _a[0]
    : undefined;
};
...
const prepareWAMessageMedia = async (message, options) => {
  ...
  const {
    ...
    fileLength,
    didSaveToTmpPath,
  } = await (0, messages_media_1.encryptedStream)(
    uploadData.media,
...
const generateWAMessage = async (jid, content, options) => {
  ...
  return (0, exports.generateWAMessageFromContent)(
    jid,
    await (0, exports.generateWAMessageContent)(content, options),
    options,
  );
};
