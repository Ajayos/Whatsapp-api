...
const getUserAgent = (config) => {
    ...
    const platform = config.mobile ? Proto_1.proto.ClientPayload.UserAgent.Platform.IOS : Proto_1.proto.ClientPayload.UserAgent.Platform.MACOS;
...
const generateMobileNode = (config) => {
    ...
    const payload = {
        ...
        dnsSource: {
            appCached: false,
            dnsMethod: Proto_1.proto.ClientPayload.DNSSource.DNSResolutionMethod.SYSTEM,
        },
        passive: false,
        pushName: 'test',
...
const generateRegistrationNode = ({ registrationId, signedPreKey, signedIdentityKey }, config) => {
    ...
    const companion = {
        os: config.browser[0],
        platformType: Proto_1.proto.DeviceProps.PlatformType.DESKTOP,
