...
export declare const getKeyAuthor: (
...
export declare const debouncedTimeout: (
  intervalMs?: number,
  task?: () => void,
) => {
...
export declare function promiseTimeout<T>(
  ms: number | undefined,
  promise: (resolve: (v: T) => void, reject: (error: any) => void) => void,
): Promise<T>;
export declare const generateMessageID: () => string;
export declare function bindWaitForEvent<T extends keyof BaileysEventMap>(
...
export declare const bindWaitForConnectionUpdate: (
  ev: BaileysEventEmitter,
) => (
  check: (
...
export declare const printQRIfNecessaryListener: (
  ev: BaileysEventEmitter,
  logger: Logger,
) => void;
/**
 ...
 */
export declare const fetchLatestWaWebVersion: (
 ...
 */
export declare const getStatusFromReceiptType: (
